...
/*
     FILE ARCHIVED ON 14:11:25 Dec 6, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:51:33 Jan 10, 2017.
...
(function (root, factory) {
   ...
   * /web/20161206141125/http://www.wtfpl.net/
   */
  /**
  ...
  (function (window, document, Chartist) {
    ...
    Chartist.createSvg = function (container, width, height, className) {
      ...
      // Since the DOM API does not support namespaces we need to manually search the returned list /web/20161206141125/http://www.w3.org/TR/selectors-api/
    ...
    ///web/20161206141125/http://schepers.cc/getting-to-the-point
  ...
  (function(window, document, Chartist) {
    ...
    // See /web/20161206141125/http://mozilla.6506.n7.nabble.com/Specyfing-paths-with-percentages-unit-td247474.html
    // Update: can be done using the above method tested here: /web/20161206141125/http://codepen.io/gionkunz/pen/KDvLj
  ...
  (function(window, document, Chartist) {
    ...
    /**
     * This method creates a foreignObject (see /web/20161206141125/https://developer.mozilla.org/en-US/docs/Web/SVG/Element/foreignObject) that allows to embed HTML content into a SVG graphic. With the help of foreignObjects you can enable the usage of regular HTML elements inside of SVG where they are subject for SVG positioning and transformation but the Browser will use the HTML rendering capabilities for the containing DOM.
     *
     * @memberof Chartist.Svg
    ...
    function foreignObject(content, attributes, className, insertFirst) {
      ...
      // /web/20161206141125/http://www.w3.org/TR/SVG/extend.html#ForeignObjectElement)
     ...
     * See [bugzilla.mozilla.org](/web/20161206141125/https://bugzilla.mozilla.org/show_bug.cgi?id=530985)
     *
     * @memberof Chartist.Svg
    ...
    /**
     * The animate function lets you animate the current element with SMIL animations. You can add animations for multiple attributes at the same time by using an animation definition object. This object should contain SMIL animation attributes. Please refer to /web/20161206141125/http://www.w3.org/TR/SVG/animate.html for a detailed specification about the available animation attributes. Additionally an easing property can be passed in the animation definition object. This can be a string with a name of an easing function in `Chartist.Svg.Easing` or an array with four numbers specifying a cubic Bézier curve.
    ...
    /**
     * This method checks for support of a given SVG feature like Extensibility, SVG-animation or the like. Check /web/20161206141125/http://www.w3.org/TR/SVG11/feature for a detailed list.
     *
     * @memberof Chartist.Svg
  ...
  (function(window, document, Chartist) {
    ...
    function createChart(options) {
      ...
      // See this proposal for more details: /web/20161206141125/http://lists.w3.org/Archives/Public/www-svg/2003Oct/0000.html
      radius -= options.donut ? options.donutWidth / 2  : 0;

      // If a donut chart then the label position is at the radius, if regular pie chart it's half of the radius
      // see /web/20161206141125/https://github.com/gionkunz/chartist-js/issues/21
