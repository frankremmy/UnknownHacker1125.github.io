window.onload = function(){
  ...
  gameState.prototype = {
    ...
    create:function(){
      ...
      //physics
    //arcade for debris
      this.game.physics.startSystem(Phaser.Physics.ARCADE); this.game.physics.startSystem(Phaser.Physics.P2JS); 
    ...
    this.game.physics.p2.world.defaultContactMaterial.friction = 0.3;
      ...
      this.scoreText = this.game.add.text(50, 30, "", {fill: "#005a5a", font:"bold 10px 'Press Start 2P', sans-serif"});
  ...
  game.state.start('gameState', false, false, {initFunc:removeCover});
}
